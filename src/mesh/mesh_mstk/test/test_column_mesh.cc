...
TEST(COLUMN_MESH_3D)
{
  ...
  Amanzi::AmanziMesh::Entity_ID_List col1;
  mesh->cells_of_column(10,col1);
  CHECK_EQUAL(4, col1.size());
  Amanzi::AmanziMesh::Entity_ID_List col2;
  mesh->faces_of_column(10,col2);
  CHECK_EQUAL(5, col2.size());
