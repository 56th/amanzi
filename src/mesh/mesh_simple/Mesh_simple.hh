...
class Mesh_simple : public virtual Mesh {
 ...
 private:
  ...
  mutable std::vector<Entity_ID_List> side_sets_;
  mutable std::vector<Entity_ID_List> element_blocks_;
  mutable std::vector<Entity_ID_List> node_sets_;
